...
alias guestconf='v ~/dotfiles/modules/guest.nix'
alias hostconf='v ~/dotfiles/modules/host.nix'
alias hwconf='v ~/dotfiles/modules/hwconf.nix'
alias guestagentsconf='v ~/dotfiles/modules/guest-agents.nix'
