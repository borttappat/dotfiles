 #!/bin/bash
    ...
    files=("config" "configuration.nix" "picom.conf" ".xinitc" "alacritty.yml" "Cerise.jpg" "config.fish" "config.rasi" "cozette.otb" "rc.conf" "rifle.conf" "Schematic.png" "startup.sh")
