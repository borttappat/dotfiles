...
abbr -a guestconf 'vim ~/dotfiles/modules/guest.nix'
abbr -a hostconf 'vim ~/dotfiles/modules/host.nix'
abbr -a hwconf 'vim ~/dotfiles/modules/hwconf.nix'
abbr -a guestagentsconf 'vim ~/dotfiles/modules/guest-agents.nix'
