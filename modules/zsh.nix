...

{
  ...
  programs.zsh = {
    ...
    # All shell configuration moved to interactiveShellInit
    interactiveShellInit = ''
      ...
      # Starship is handled separately by NixOS
  ...
  system.activationScripts.setupZshDefaults = {
    text = ''
      mkdir -p /etc/skel
      cat > /etc/skel/.zshrc << 'EOF'
      # Source the system-wide zsh configuration
      source /etc/zshrc
      EOF
    '';
  };
