...
def generate_variations(word, leet_level='basic'):
    ...
    def get_all_cases(word):
        ...
        return {''.join(c.upper() if i & (1 << j) else c.lower()
...
def add_common_suffixes(variations, min_length=None, max_length=None, complexity='basic'):
    result = set()
...
def main():
    parser = argparse.ArgumentParser(description='Generate a wordlist with various transformations')
    ...
    parser.add_argument('--complexity', choices=['basic', 'advanced'], default='basic',
    ...
    if args.stream:
        ...
        with open(args.output, 'w') as f:
            ...
            for word in words:
                ...
                variations = add_common_suffixes(variations, args.min, args.max, args.complexity)
